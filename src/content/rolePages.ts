...
export const rolePages: RolePageContent[] = [
  ...
  },
  {
    ...
    sub: 'Capture change orders on the jobsite by voice, price them with your own labor rates and markup, route them to the general contractor, and bill them the moment they are approved.',
    ctaLabel: 'Start as a Subcontractor',
    metaTitle: 'Ontime.build for Subcontractors — Change Orders & Invoicing',
    metaDescription: 'Capture change orders by voice, price labor and materials with your markup, route them to the general contractor, and invoice approved work without spreadsheets.',
    problems: [
    ...
    solution: [
      ...
      { title: 'Your rates, your markup', body: 'Internal cost stays yours. Billable amount is what the general contractor sees — the spread is never exposed.' },
    ...
    workflow: [
      ...
      { step: '03', title: 'Route it upstream', body: 'Send to the general contractor. Status moves from submitted to approved with a visible trail.' },
    ...
    features: [
      ...
      { title: 'Material responsibility', body: 'Clear rules for whether you or the general contractor procures, so nobody double-orders.' },
      { title: 'Crew assignment', body: 'Push work to crews and get updates, hours, and photo proof back.' },
      { title: 'Contract tracking', body: 'Original sum, approved changes, revised sum, billed to date, remaining.' },
      { title: 'Purchase orders', body: 'Order material against the project and route to the general contractor when they own the account.' },
    ],
    proof: [
    ...
    faq: [
      { q: 'Can the general contractor see my labor cost?', a: 'No. They see the billable amount. Your base rate and markup stay internal unless you choose to disclose them.' },
      { q: 'Does the general contractor need to be on Ontime?', a: 'It is better if they are, but you can send change orders and invoices out by external approval link.' },
  ...
  },
  {
    ...
    ctaLabel: 'Start as a Crew',
    metaTitle: 'Ontime.build for Crews — Assigned Work & Field Updates',
    ...
    faq: [
      { q: 'Can crews see project money?', a: 'No. Crew views exclude budgets, margins, and supplier pricing entirely.' },
