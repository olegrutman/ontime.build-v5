...
const GC_STEPS: BoltStep[] = [
  { id: 'gc-1', pose: 'wave', instruction: 'Welcome! This is your project overview — contracts and urgent items live here.', explanation: 'The overview gives General contractors a bird\'s-eye view of every active project. Urgent items float to the top so nothing slips.', targetTab: 'overview', targetSelector: '[data-demo-target="attention-banner"]' },
  ...
  { id: 'gc-3', pose: 'thinking', instruction: 'Open a Work Order to review details, approve pricing, or check field-crew hours.', explanation: 'General contractors approve Work Order pricing before the subcontractor can invoice. T&M orders show real-time labor logs.', targetSelector: '[data-demo-target="wo-card-0"]' },
  ...
  { id: 'gc-co', pose: 'point', instruction: 'The Change Order Impact card shows what COs are doing to your contract.', explanation: 'Revenue = approved CO additions to the contract sum. Cost = your true cost (subcontractor labor + materials + equipment) — General contractors see raw costs, not subcontractor markup. Margin = revenue − cost. Pending exposure = COs submitted but not yet approved, so you know what is heading at the budget.', targetTab: 'overview', targetSelector: '[data-demo-target="co-impact-card"]' },
  { id: 'gc-6', pose: 'celebrate', instruction: 'That\'s the general contractor tour! Next: invite your team and create your first real project.', explanation: 'Onboarding takes 5 minutes. Add your subcontractor partners and suppliers, then Ontime tracks everything automatically.' },
];
...
const FC_STEPS: BoltStep[] = [
  ...
  { id: 'fc-5', pose: 'point', instruction: 'Invoices show your billing history for completed work.', explanation: 'Crew invoices are generated from locked WOs. Retainage is held per the contract.', targetTab: 'invoices' },
  { id: 'fc-co', pose: 'point', instruction: 'COs you worked on roll up into this card so you can see what you earned.', explanation: 'Revenue = what your subcontractor owes you for approved COs. Cost = your labor + materials. Pending exposure = COs you have submitted that are still waiting on subcontractor approval.', targetTab: 'overview', targetSelector: '[data-demo-target="co-impact-card"]' },
  { id: 'fc-6', pose: 'celebrate', instruction: 'That\'s it! Simple and focused — just the way field work should be.', explanation: 'Your TC handles pricing and general contractor approvals. You focus on the work.' },
];
