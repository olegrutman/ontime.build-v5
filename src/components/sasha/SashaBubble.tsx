...
export function SashaBubble() {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {open && (
        <div className="fixed z-50 shadow-xl rounded-2xl border bg-background flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 fade-in duration-200 bottom-40 lg:bottom-20 right-2 left-auto w-[min(300px,calc(100vw-5rem))] sm:w-[min(400px,calc(100vw-2rem))] sm:right-4 max-h-[45vh] sm:max-h-[min(500px,70vh)]">
          {/* Header */}
      ...
      {/* Floating Bubble */}
      <div className="fixed bottom-24 lg:bottom-4 right-4 z-50 flex items-center gap-2">
        {/* Tooltip label */}
