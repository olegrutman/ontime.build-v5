    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogTrigger asChild>
        {variant === 'link' ? (
          ...
          <button
            type="button"
            className="inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-[0.7rem] font-bold uppercase tracking-wide text-primary hover:bg-primary/10 transition-colors"
            onClick={(e) => e.stopPropagation()}
          >
