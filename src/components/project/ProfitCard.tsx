...
export function ProfitCard({ financials, projectId }: ProfitCardProps) {
  ...
  if (viewerRole === 'General Contractor') {
    if (editing) {
      return (
        <div className="bg-card border border-border rounded-lg px-3.5 py-3.5 space-y-3">
          <p className="text-[0.7rem] uppercase tracking-[0.4px] text-muted-foreground font-medium">Set Owner Contract Value</p>
    ...
    return (
      <div className="bg-card border border-border rounded-lg px-3.5 py-3.5 space-y-2.5" data-sasha-card="Profit Position">
        <div className="flex items-center gap-1.5 mb-1">
          <TrendingUp className="h-4 w-4 text-muted-foreground" />
          <span className="text-[0.7rem] uppercase tracking-[0.4px] text-muted-foreground font-medium">Profit Position</span>
        </div>
  ...
  if (viewerRole === 'Field Crew') {
    ...
    return (
      <div className="bg-card border border-border rounded-lg px-3.5 py-3.5 space-y-2.5">
        <div className="flex items-center gap-1.5 mb-1">
          <TrendingUp className="h-4 w-4 text-muted-foreground" />
          <span className="text-[0.7rem] uppercase tracking-[0.4px] text-muted-foreground font-medium">Profit Position</span>
        </div>
