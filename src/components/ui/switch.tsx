...
/**
 * ElongatedSwitch — a wider, mobile-style toggle with an orange (primary)
 * track and high-contrast white thumb. Use in list rows where the standard
 * compact switch is hard to tap or visually too small.
 */
const ElongatedSwitch = React.forwardRef<
  React.ElementRef<typeof SwitchPrimitives.Root>,
  React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root>
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
...
ElongatedSwitch.displayName = "ElongatedSwitch";

export { Switch, ElongatedSwitch };
