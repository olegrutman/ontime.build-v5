      ...
      questions: [
        {
          ...
          hint: 'Options match the location you picked.',
          grid: 'cols-4',
          answersFor: membersForZone,
      ...
      questions: [
        {
          ...
          answers: [
            ...
            { id: 'gc_directed',    label: 'Contractor-directed fix',   icon: '👷' },
    ...
    damage: {
      ...
      questions: [
        ...
        },
        {
          ...
          grid: 'cols-4',
          why: 'Townhome',
          annotation: '<b>Townhome-specific:</b> damage to a <b>demising wall</b> or floor/ceiling assembly between units means coordination with the neighboring unit\'s general contractor — access, sound flanking, fire separation all affected.',
          answersFor: actionsForZone,
          answers: ACTIONS_BY_ZONE.default,
        },
        {
