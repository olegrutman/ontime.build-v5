CREATE OR REPLACE FUNCTION public.notify_estimate_decision(_estimate_id uuid, _approved boolean, _reason text DEFAULT NULL::text)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  WHERE uor.organization_id = _est.supplier_org_id;
