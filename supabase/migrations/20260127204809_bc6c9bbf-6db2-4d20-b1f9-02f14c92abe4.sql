-- Fix convert_change_order_to_contract to use correct contract direction
-- Contracts go FROM contractor (who bills) TO client (who pays)
-- TC bills GC, so TC is from_org and GC is to_org
